import{j as a,b as n,c as s,aa as p}from"./chunks/framework.Bxf40uRC.js";const m=JSON.parse('{"title":"Go语言之unsafe","description":"","frontmatter":{},"headers":[],"relativePath":"Go/Go语言之unsafe.md","filePath":"Go/Go语言之unsafe.md","lastUpdated":1711094318000}'),e={name:"Go/Go语言之unsafe.md"},t=p(`<h1 id="go语言之unsafe" tabindex="-1">Go语言之unsafe <a class="header-anchor" href="#go语言之unsafe" aria-label="Permalink to &quot;Go语言之unsafe&quot;">​</a></h1><h2 id="go指针和unsafe-pointer有什么区别" tabindex="-1">Go指针和unsafe.Pointer有什么区别？ <a class="header-anchor" href="#go指针和unsafe-pointer有什么区别" aria-label="Permalink to &quot;Go指针和unsafe.Pointer有什么区别？&quot;">​</a></h2><h3 id="限制1" tabindex="-1">限制1 <a class="header-anchor" href="#限制1" aria-label="Permalink to &quot;限制1&quot;">​</a></h3><p>Go语言的指针不能够进行数学运算</p><div class="language-golang vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">golang</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>a := 5</span></span>
