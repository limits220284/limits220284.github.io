import{j as n,b as a,c as s,aa as e}from"./chunks/framework.BrJMe4p_.js";const m=JSON.parse('{"title":"Go语言中的通道","description":"","frontmatter":{},"headers":[],"relativePath":"Go/Go语言之通道.md","filePath":"Go/Go语言之通道.md","lastUpdated":1711094318000}'),p={name:"Go/Go语言之通道.md"},l=e(`<h1 id="go语言中的通道" tabindex="-1">Go语言中的通道 <a class="header-anchor" href="#go语言中的通道" aria-label="Permalink to &quot;Go语言中的通道&quot;">​</a></h1><h2 id="什么是csp" tabindex="-1">什么是CSP？ <a class="header-anchor" href="#什么是csp" aria-label="Permalink to &quot;什么是CSP？&quot;">​</a></h2><p>CSP 全称是 “Communicating Sequential Processes”</p><h2 id="channel的底层数据结构是什么" tabindex="-1">Channel的底层数据结构是什么？ <a class="header-anchor" href="#channel的底层数据结构是什么" aria-label="Permalink to &quot;Channel的底层数据结构是什么？&quot;">​</a></h2><div class="language-golang vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">golang</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>type hchan struct {</span></span>
