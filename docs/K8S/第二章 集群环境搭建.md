...
![image-20200404094800622](https://s2.loli.net/2024/04/18/7XrBCh3Y5KUPTt8.png)
...
- 网络配置：按照下面配置网路地址信息
  ...
  ~~~md
  网络地址：192.168.131.100  （每台主机都不一样  分别为100、101、102）
  子网掩码：255.255.255.0
  默认网关：192.168.131.2
  DNS：    223.5.5.5
  ~~~

  ![image-20200505213817934](https://s2.loli.net/2024/04/18/CZUat4izW2YB6m3.png)
...
- 主机名设置：按照下面信息设置主机名
  ...
  ![image-20200505214156148](https://s2.loli.net/2024/04/18/QrXUkbIpnlRZFuG.png)
...
[root@master ~]# kubeadm init \
    ...
    --apiserver-advertise-address=192.168.131.100
...
<img src="https://s2.loli.net/2024/04/18/KJ7vIHnSciUju19.png" alt="image-20200405142656921" style="zoom:80%; border:1px solid" />
...
1. k8s创建完集群之后coredns一直处于pending状态

   解决办法：https://www.cnblogs.com/jinci2022/p/16809278.html