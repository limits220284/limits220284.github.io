...
<img src="https://s2.loli.net/2024/04/03/1VrwNAljP9DGai8.webp" alt="图片" style="zoom:50%;" />
...
1. 即时一致性问题
![图片](https://s2.loli.net/2024/04/03/vZj1KCWspmtFd3g.webp)

​	**主节点处理完数据直接返回，但是异步复制的时候出现拷贝到子节点出现问题**

2. 顺序一致性问题

![图片](https://s2.loli.net/2024/04/03/6vAhmCqbZGTx53d.webp)



​	**主节点处理两个操作，后面的操作因为前一个操作网络延迟，先操作数据，导致数据不一致**



## A

![图片](https://s2.loli.net/2024/04/03/O9RH1AheLtPNQrs.webp)

​	**如果为了保证数据的强一致性，就会出现数据复制出现网络延迟，导致响应客户端非常慢的情况**
