...
<img src="https://s2.loli.net/2024/04/18/8uXd5jcQ4plN9Cf.png" alt="image-20200407121501907" style="zoom:80%;" />
...
<img src="https://s2.loli.net/2024/04/18/rwnA6idVksL3P4m.png" alt="image-20200412111402706" style="border:solid 1px" />
...
6. apiServer将接收到的pod状态信息存入etcd中
   ...
   <img src="https://s2.loli.net/2024/04/18/sGJ97BAaCSOuUoy.png" alt="image-20200406184656917" style="zoom:100%;" />
...
- OnFailure ： 容器终止运行且退出码不为0时重启(不为零，就代表异常重启)
...
- **定向调度**：NodeName、NodeSelector(通过node name或者标签选择调度)
...
<img src="https://s2.loli.net/2024/04/18/U1hQpxvDWZXibRy.png" alt="image-20200605021606508" style="border:1px solid" />
...
![image-20240418100743079](https://s2.loli.net/2024/04/18/2cXQaMAlRewLE1v.png)
