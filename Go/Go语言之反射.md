...
![r=tty](https://s2.loli.net/2023/12/27/p2GjNhKDJsEFBUe.png)
...
![w = r.(io.Writer)](https://golang.design/go-questions/stdlib/reflect/assets/3.png)
...
![empty=w](https://s2.loli.net/2023/12/27/1VS7ABkj3FQ6g8i.png)



### 反射的基本函数

 reflect包里定义了一个接口个和一个结构体，即reflect.Type 和reflect.Value，**它们提供很多函数来获取存储在接口里的类型信息**。
...
![三者关系](https://s2.loli.net/2023/12/27/POlwFGT7kJbWEcy.png)
...
![value rtype](https://s2.loli.net/2023/12/27/Jl7BbErGtMpSDXj.png)
